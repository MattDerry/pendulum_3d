...
class PendulumSimulator:
    ...
    def start_controlled_interactive(self):
        ...
        for i, t in enumerate(tvec):
            if i > 200 and i < 400:
                ...
                self.qd_comb[i, link1_rx_index] = QBAR_DIP  # Set desired configuration trajectory
                self.qd_comb[i, link1_ry_index] = QBAR_DIP
    ...
    def calc_correlations(self):
        ...
        cmd_x_corr = numpy.correlate(self.user_input_trajectory[:,0], self.controller_input_trajectory[:,0], 'full')
        cmd_y_corr = numpy.correlate(self.user_input_trajectory[:,1], self.controller_input_trajectory[:,1], 'full')
